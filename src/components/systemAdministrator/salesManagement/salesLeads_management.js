                ...
                <div className="oa-common-right-box">
                    ...
                    <div className="oa-cdpe-groupselect" >
                        ...
                        <div className="oa-sm-buttongroup">
                            ...
                            <Button style={{marginLeft:'30px',backgroundColor:'red',border:'0'}} type="primary" href='./'>新建</Button>
                        </div>
                                    ...
                                    {this.state.data.map(function(valus,key){
                                        return(
                                            <tr className="oa-cdpe-databable">   
                                                ...
                                                <td>
                                                    <Link className='oa-ta-a' to='/cdp_formulate:id' key={key}>编辑</Link>
                                                    <span style={{padding:'0 15px'}}>|</span>
                                                    <Link className='oa-ta-a' to='/'>删除</Link>
                                                </td>
                                            </tr> 
                                        )
                                    })}
