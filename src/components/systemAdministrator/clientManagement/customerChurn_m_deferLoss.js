...
class customerChurn_m_deferLoss extends React.Component{
    constructor(){
        super()
        this.state={
            jurisdiction:true,
 ...
 componentWillMount () {
    ...
    axios({
        method:'get',
        url:'api/people/liushi_zanhuan?id='+id,
                ...
                <div className="oa-common-right-box">
                    ...
                    <div className="oa-crumbs-box" style={{padding:'10px'}}>
                        <Breadcrumb separator=">">
                            ...
                            <Breadcrumb.Item >暂缓流失</Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                            ...
                            <div className="oa-snc-inbox">
                                <ul className="oa-snc-formbox">
                                    ...
                                    <li>
                                        ...
                                        <div className="oa-snc-groupinput1">
                                            <div className="oa-snc-ginput-left">流失时间</div>
                                    ...
                                    <li>
                                        <div className="oa-snc-textarea">
                                            <div className="oa-snc-ginput-left2">暂缓措施</div>
                                            <textarea name='zanhuan' value={this.state.zanhuan} onChange={e=>{this.getInput(e)}}></textarea>
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
export default customerChurn_m_deferLoss